import { ArrowRight, BookOpen, Calendar, CheckCircle2, Circle } from "lucide-react"
...
export function TodoCard({ todo, context }: TodoCardProps) {
  ...
  return (
    <div
      className={[
        "bg-white rounded-2xl p-5 shadow-[0px_8px_24px_rgba(11,28,48,0.06)] border border-[#e8eeff] transition-opacity duration-150",
        isDone ? "opacity-60" : "",
      ].join(" ")}
    >
